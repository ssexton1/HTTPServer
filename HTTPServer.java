...
public class HTTPServer {
    ...
    private static final String ROOT_PATH = "/Users/sean/Desktop/School/Info314/HTTPServer";
    ...
    private static void determineMethod(String method, String path, BufferedReader in, PrintWriter out, HashMap<String, String> headers) throws IOException {
        System.out.println("Method: " + method);
    ...
    private static void handleGETRequest(File file, PrintWriter out, String mimeType) throws IOException, FileNotFoundException {
        if (file.exists()) {
    ...
    private static void handlePOSTRequest(File file, BufferedReader in, PrintWriter out, HashMap<String, String> headers) throws IOException, FileNotFoundException {
        if (file.exists()) {
    ...
    private static void handlePUTRequest(File file, BufferedReader in, PrintWriter out, HashMap<String, String> headers) throws IOException {
        if (!file.exists()) {
            file.createNewFile();
        }
    ...
    private static void sendResponse(int statusCode, String statusMessage, PrintWriter out, String mimeType, int bodyLength) throws IOException {
    ...
    private static void sendError(int statusCode, String statusMessage, PrintWriter out, String mimeType, int bodyLength) throws IOException {
